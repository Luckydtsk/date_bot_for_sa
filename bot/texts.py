...
ASK_CONTACT = (
    "У тебя скрыт username в Telegram — после match сложно будет связаться.\n"
    "Напиши контакт вручную: @ник, телефон или «напиши в ЛС по id».\n"
    "Или нажми «Пропустить» — тогда в match будет только Telegram id."
)
...
LIKE_REJECTED = "Не удалось поставить лайк — анкета недоступна."
DISLIKE_DONE = "Ок, дальше."
REG_CONTINUE = "Продолжим заполнение анкеты 👇"
FSM_NEED_TEXT = "Нужен текст или кнопка ниже."
FSM_NEED_PHOTO = "Пришли фото или нажми «Назад»."
SOMEONE_LIKED_YOU = "Кто-то лайкнул твою анкету! Загляни в «💘 Кому я нравлюсь»."

# --- Match ---
MATCH_TITLE = "Это match! 🎉\nВы оба готовы познакомиться ради бала."
...
CONFIRM_REFILL = (
    ...
    "Пока заполняешь, старая анкета скрыта. Лайки и matches сбросятся "
    "только когда закончишь новую."
)
EDIT_DONE = "Обновили!"
...
USERNAME_MISSING_WARN = (
    ...
    "(Настройки → Имя пользователя), после match кнопка «Написать» может не появиться. "
...
BAN_ADMIN_FORBIDDEN = "Нельзя банить админов."
USERS_BANNED_EMPTY = "Забаненных анкет нет."
USERS_BAN_EMPTY = "Некого банить (все остальные — админы или анкет нет)."
